...
const duel = () => {
    ...
    setTimeout(() => {
        axios.post('http://ec2-18-246-44-216.us-west-2.compute.amazonaws.com/api/duel', {compDuo, playerDuo})
            .then(({data}) => {
...
const getPlayerStats = () => {
    axios.get('http://ec2-18-246-44-216.us-west-2.compute.amazonaws.com/api/player')
...
const getAllBots = () => {
    axios.get('http://ec2-18-246-44-216.us-west-2.compute.amazonaws.com/api/robots')
        .then(({data}) => {
